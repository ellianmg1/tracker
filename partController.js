...
exports.part_detail = function(req, res, next) {
    ...
    async.parallel({
        ...
        // Successful, so render
        res.render('part_detail', { title: 'Part Detail', part: results.part } );
    });
...
exports.part_create_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (err) { return next(err); }
        res.render('part_form', { title: 'Add Part Details',cars:results.cars });
    });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                // render form
                res.render('part_form', { title: 'Add Part Details',cars:results.cars, part: part, errors: errors.array() });
            });
            return;
        }
        else {
...
exports.part_update_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        cars: function(callback) {
            ...
            // Success.
            res.render('part_form', { title: 'Update Part Info', cars:results.cars, part: results.part });
        });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                if (err) { return next(err); }
                res.render('part_form', { title: 'Update Part Info', cars:results.cars, part: Part, errors: errors.array() });
            });
            return;
        }
        else {
